...
RUN apt-get update && apt-get -y install git curl apache2 php7.0 php7.0-mysql php7.0-mcrypt php7.0-json php7.0-imap libapache2-mod-php7.0 php7.0-sqlite3 && apt-get clean && rm -rf /var/lib/apt/lists/*
